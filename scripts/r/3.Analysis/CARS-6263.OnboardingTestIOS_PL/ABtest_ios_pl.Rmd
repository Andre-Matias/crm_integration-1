...
```{r}
setwd("~/Verticals-bi/scripts/r/3.Analysis/CARS-6263.OnboardingTestIOS_PL")
...
When considering only the same day, variation is - 24% below original. It's NOT significant yet.
```{r}
