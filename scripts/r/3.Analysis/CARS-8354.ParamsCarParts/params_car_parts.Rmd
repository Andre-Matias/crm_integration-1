...
# ######################################################################################################################
#' Analysis: Car Parts Parameters Usage
#' 
...
```{r}
ads_pl <- filter(ads, livesync_dbname =='otomotopl') 
dim(ads_pl)
length(unique(ads_pl$id)) #there are dupplcated ads

ads_pt <- filter(ads, livesync_dbname =='carspt') 
dim(ads_pt)
length(unique(ads_pt$id)) # no duplicated ads

ads_ro <- filter(ads, livesync_dbname =='autovitro') 
dim(ads_ro)
length(unique(ads_ro$id)) #there are dupplcated ads
```
