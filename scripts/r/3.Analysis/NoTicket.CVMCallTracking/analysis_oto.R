...
dfAdsPhones$Mobile1[dfAdsPhones$phone1=="" | is.na(dfAdsPhones$phone1)] <- NA
dfAdsPhones$Mobile2[dfAdsPhones$phone2=="" | is.na(dfAdsPhones$phone2)] <- NA
dfAdsPhones$Mobile3[dfAdsPhones$phone3=="" | is.na(dfAdsPhones$phone3)] <- NA
