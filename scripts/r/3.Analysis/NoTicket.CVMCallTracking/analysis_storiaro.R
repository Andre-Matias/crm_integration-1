...
dfAds <-
  as_tibble(readRDS("~/CT/dfAds_StoriaRO.RDS"))

dfUsers <-
  as_tibble(readRDS("~/CT/dfUsers_StoriaRO.RDS"))

dfAgents <-
  as_tibble(readRDS("~/CT/dfAgents_StoriaRO.RDS"))
...
dfAds$phone1 <-
  gsub("\\+40", "", dfAds$phone1)
dfAds$phone2 <-
  gsub("\\+40", "", dfAds$phone2)
dfAds$phone3 <-
  gsub("\\+40", "", dfAds$phone3)
