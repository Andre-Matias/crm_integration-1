...
def main(conf_file, dml_file, country):
	...
	for dml in dml_scripts:
		...
		try:
			cur.execute("lock crm_integration_anlt.t_rel_scai_country_integration, crm_integration_anlt.t_rel_scai_integration_process, crm_integration_anlt.t_lkp_scai_process, crm_integration_anlt.t_fac_scai_execution in exclusive mode")
			cur.execute(dml)
