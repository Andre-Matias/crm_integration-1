...
create temp table tmp_pl_load_resource_type
as
select
  ...
  from
    (
      ...
      from
        (
          select distinct resource_type from crm_integration_stg.stg_pl_d_base_calls where resource_type is not null
          union
          select distinct resource_type from crm_integration_stg.stg_pl_d_base_tags where resource_type is not null
          union
          select distinct resource_type from crm_integration_stg.stg_pl_d_base_sources where resource_type is not null
          union
          select distinct resource_type from crm_integration_stg.stg_pl_d_base_tasks where resource_type is not null
        ) a,
        (
          select
            rel_integr_proc.dat_processing,
...
create temp table tmp_pl_load_industry
as
select
...
from
    (
      ...
      from
        (
          select distinct base_account_country+base_account_category opr_source_system,industry from crm_integration_stg.stg_pl_d_base_contacts where industry is not null
          union
          select distinct base_account_country+base_account_category opr_source_system,industry from crm_integration_stg.stg_pl_d_base_leads where industry is not null
        ) a,
...
insert into crm_integration_anlt.t_lkp_industry
    select
      ...
      opr_industry,
      dsc_industry,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_industry') valid_from, 
      20991231 valid_to,
      cod_source_system,
	  cod_execution
    from
      tmp_pl_load_industry
    where
      dml_type = 'I';
...
create temp table tmp_pl_load_lead_status
as
select
...
from
    (
      ...
      from
        (
          select distinct base_account_country+base_account_category opr_source_system,status from crm_integration_stg.stg_pl_d_base_leads where status is not null
        ) a,
        crm_integration_anlt.t_lkp_source_system b,
        (
          select
...
analyze tmp_pl_load_lead_status;
...
insert into crm_integration_anlt.t_lkp_lead_status
    select
      ...
      opr_lead_status,
      dsc_lead_status,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_lead_status') valid_from, 
      20991231 valid_to,
      cod_source_system,
	  cod_execution
    from
      tmp_pl_load_lead_status
    where
      dml_type = 'I';
...
create temp table tmp_pl_load_product
as
select
...
from
    (
      ...
      from
        (
          select distinct base_account_country+base_account_category opr_source_system,sku from crm_integration_stg.stg_pl_d_base_line_items where sku is not null
        ) a,
        crm_integration_anlt.t_lkp_source_system b,
        (
          select
...
insert into crm_integration_anlt.t_lkp_product
    select
      ...
      opr_sku,
      dsc_sku,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_product') valid_from, 
      20991231 valid_to,
      cod_source_system,
	  cod_execution
    from
...
create temp table tmp_pl_load_currency
as
select
  ...
  from
    (
      ...
      from
        (
          select distinct currency from crm_integration_stg.stg_pl_d_base_line_items where currency is not null
        ) a,
        (
          select
            rel_integr_proc.dat_processing,
...
insert into crm_integration_anlt.t_lkp_currency
    select
      ...
      opr_currency,
      dsc_currency,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_currency') valid_from, 
      20991231 valid_to,
      cod_source_system,
	  cod_execution
    from
      tmp_pl_load_currency
    where
      dml_type = 'I';
...
create temp table tmp_pl_load_source
as
select
  ...
  from
    (
      ...
      from
        (
          select distinct source from db_atlas_verticals.ads, crm_integration_anlt.t_lkp_source_system where source is not null and livesync_dbname = opr_source_system and cod_country = 2
          union
          select distinct source from db_atlas.olxpl_ads where source is not null
          union
          select distinct source from db_atlas_verticals.payment_session, crm_integration_anlt.t_lkp_source_system where source is not null and livesync_dbname = opr_source_system and cod_country = 2
          union
          select distinct source from db_atlas.olxpl_payment_session where source is not null
          union
          select distinct source from db_atlas_verticals.answers, crm_integration_anlt.t_lkp_source_system where source is not null and livesync_dbname = opr_source_system and cod_country = 2
          union
          select distinct source from db_atlas.olxpl_answers where source is not null
        ) a,
        (
          select
            rel_integr_proc.dat_processing,
...
insert into crm_integration_anlt.t_lkp_source
    select
      ...
      opr_source,
      dsc_source,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_source') valid_from, 
      20991231 valid_to,
      cod_source_system,
	  cod_execution
    from
...
create temp table tmp_pl_load_event
as
select
  ...
  from
    (
      ...
      from
        (
          select distinct action_type event_type from crm_integration_stg.stg_pl_hydra_web where action_type is not null
          union
          select distinct trackname event_type from crm_integration_stg.stg_pl_hydra_verticals_web where trackname is not null
        ) a,
        (
          select
            rel_integr_proc.dat_processing,
...
insert into crm_integration_anlt.t_lkp_event
    select
      ...
      opr_event,
      dsc_event,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_event') valid_from, 
      20991231 valid_to,
      cod_source_system,
	  cod_execution
    from
...
create temp table tmp_pl_load_base_source 
...
analyze tmp_pl_load_base_source;
	

	
delete from crm_integration_anlt.t_lkp_base_source
using tmp_pl_load_base_source
where 
...
from tmp_pl_load_base_source source
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_base_source),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_base_user 
distkey(cod_source_system)
...
analyze tmp_pl_load_base_user;


	
delete from crm_integration_anlt.t_lkp_base_user
using tmp_pl_load_base_user
where 
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_base_user') 
from tmp_pl_load_base_user source
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_base_user),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_task 
distkey(cod_source_system)
...
analyze tmp_pl_load_task;

	
delete from crm_integration_anlt.t_lkp_task
using tmp_pl_load_task
where 
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_task),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_call_outcome 
distkey(cod_source_system)
...
analyze tmp_pl_load_call_outcome;


	
delete from crm_integration_anlt.t_lkp_call_outcome
using tmp_pl_load_call_outcome
where 
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_call_outcome') 
from tmp_pl_load_call_outcome source
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_call_outcome),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
where 
	crm_integration_anlt.tmp_pl_load_contact.dml_type = 'I' 
	and t_lkp_contact.opr_contact = crm_integration_anlt.tmp_pl_load_contact.opr_contact 
...
where
gen_num between 1 and trunc((select max(regexp_count(custom_fields, '\\","'))/2/2 from crm_integration_anlt.tmp_pl_load_contact)) --(select max(regexp_count(custom_fields, '\\","') + 1) from crm_integration_anlt.tmp_pl_load_contact)
;
...
where
gen_num between  trunc((select max(regexp_count(custom_fields, '\\","'))/2 from crm_integration_anlt.tmp_pl_load_contact)) +1 and trunc((select max(regexp_count(custom_fields, '\\","'))/2 from crm_integration_anlt.tmp_pl_load_contact)) + trunc((select max(regexp_count(custom_fields, '\\","'))/2/2 from crm_integration_anlt.tmp_pl_load_contact)) --(select max(regexp_count(custom_fields, '\\","') + 1) from crm_integration_anlt.tmp_pl_load_contact)
;
...
where
gen_num between  trunc((select max(regexp_count(custom_fields, '\\","'))/2 from crm_integration_anlt.tmp_pl_load_contact))+trunc((select max(regexp_count(custom_fields, '\\","'))/2/2 from crm_integration_anlt.tmp_pl_load_contact))+1 and trunc((select max(regexp_count(custom_fields, '\\","')) from crm_integration_anlt.tmp_pl_load_contact)) + 1 --(select max(regexp_count(custom_fields, '\\","') + 1) from crm_integration_anlt.tmp_pl_load_contact)
;
...
analyze tmp_pl_load_custom_field;
...
create temp table tmp_pl_rel_contact_custom_field as
  select
    source.cod_contact,
  ...
  from
    (
      select
        ...
        scai_execution.cod_execution
      from
        tmp_pl_contact_custom_field tmp_cf,
...
analyze tmp_pl_rel_contact_custom_field;
...
from tmp_pl_rel_contact_custom_field source
...
insert into crm_integration_anlt.t_rel_contact_custom_field
  select
	...
	cod_execution
  from
    tmp_pl_rel_contact_custom_field
  where
    dml_type in ('I','U');
...
create temp table tmp_pl_load_lead 
distkey(cod_source_system)
...
analyze tmp_pl_load_lead;
	

	
delete from crm_integration_anlt.t_lkp_lead
using tmp_pl_load_lead
where 
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_lead),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_loss_reason 
distkey(cod_source_system)
...
analyze tmp_pl_load_loss_reason;
	

	
delete from crm_integration_anlt.t_lkp_loss_reason
using tmp_pl_load_loss_reason
where 
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_loss_reason') 
from tmp_pl_load_loss_reason source
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_loss_reason),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_pipeline 
distkey(cod_source_system)
...
analyze tmp_pl_load_pipeline;
	

delete from crm_integration_anlt.t_lkp_pipeline
using tmp_pl_load_pipeline
where 
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_pipeline') 
from tmp_pl_load_pipeline source
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_pipeline),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_stage 
distkey(cod_source_system)
...
analyze tmp_pl_load_stage;
	

	
delete from crm_integration_anlt.t_lkp_stage
using tmp_pl_load_stage
where 
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_stage),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_deals 
distkey(cod_source_system)
...
analyze tmp_pl_load_deals;
	

	
delete from crm_integration_anlt.t_lkp_deal
using tmp_pl_load_deals
where 
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_deals),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_calls 
distkey(cod_source_system)
sortkey(opr_call)
as
...
using tmp_pl_load_calls
where crm_integration_anlt.t_fac_call.opr_call = tmp_pl_load_calls.opr_call
and tmp_pl_load_calls.dml_type = 'U';
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_calls),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_orders 
distkey(cod_source_system)
sortkey(opr_order)
as
  select
...
using tmp_pl_load_orders
where crm_integration_anlt.t_fac_order.opr_order = tmp_pl_load_orders.opr_order
and tmp_pl_load_orders.dml_type = 'U';
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_orders),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_order_line_items 
distkey(cod_source_system)
...
analyse tmp_pl_load_order_line_items;
...
insert into crm_integration_anlt.t_hst_order_line_item
    ...
    from
      crm_integration_anlt.t_fac_order_line_item target,
      tmp_pl_load_order_line_items source
    where
...
using tmp_pl_load_order_line_items
where crm_integration_anlt.t_fac_order_line_item.opr_order_line_item=tmp_pl_load_order_line_items.opr_order_line_item
and tmp_pl_load_order_line_items.dml_type = 'U';
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(updated_at) from tmp_pl_load_order_line_items),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_paidad_index 
distkey(cod_source_system)
...
analyze tmp_pl_load_paidad_index;
	

	
delete from crm_integration_anlt.t_lkp_paidad_index
using tmp_pl_load_paidad_index
where 
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_paidad_index') 
from tmp_pl_load_paidad_index source
...
from tmp_pl_load_paidad_index source, crm_integration_anlt.t_lkp_paidad_index lkp, crm_integration_anlt.t_lkp_source_system ss
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from tmp_pl_load_paidad_index),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create temp table tmp_pl_load_atlas_user 
distkey(cod_source_system)
...
analyze tmp_pl_load_atlas_user;	


	
delete from crm_integration_anlt.t_lkp_atlas_user
using tmp_pl_load_atlas_user
where 
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_atlas_user') 
from tmp_pl_load_atlas_user source
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from tmp_pl_load_atlas_user),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
