  ...
  from
	...
	from
      ...
      SELECT
		...
		scai_execution.cod_execution
     FROM
        crm_integration_stg.stg_pl_db_atlas_verticals_categories a,
        crm_integration_anlt.t_lkp_source_system b,
       (
          select
            max(fac.cod_execution) cod_execution
	  ...
	  SELECT
		...
		scai_execution.cod_execution
	from
		crm_integration_stg.stg_pl_db_atlas_olxpl_categories,
     (
        select
          max(fac.cod_execution) cod_execution
        from
...
using crm_integration_anlt.tmp_pl_load_category
where 
	tmp_pl_load_category.dml_type = 'I' 
	and t_lkp_category.opr_category = tmp_pl_load_category.opr_category
	and t_lkp_category.valid_from = (select dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_category');

	--$$$
	
update crm_integration_anlt.t_lkp_category
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_category') 
from crm_integration_anlt.tmp_pl_load_category source
...
insert into crm_integration_anlt.t_lkp_category
    select
		...
		dsc_category_hi,
		dsc_category_uk,
		(select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_category') valid_from, 
		20991231 valid_to,
		cod_source_system,
		...
		cod_execution
    from
      crm_integration_anlt.tmp_pl_load_category
    where
      dml_type in ('U','I');
...
from crm_integration_anlt.tmp_pl_load_category source, crm_integration_anlt.t_lkp_category lkp, crm_integration_anlt.t_lkp_source_system ss
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_category),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pl_load_region;

create table crm_integration_anlt.tmp_pl_load_region 
distkey(cod_source_system)
  ...
  from
	...
	(
      SELECT
        ...
        scai_execution.cod_execution
      FROM
        crm_integration_stg.stg_pl_db_atlas_verticals_regions a,
        crm_integration_anlt.t_lkp_source_system b,
        (
          select
            max(fac.cod_execution) cod_execution
	  ...
	  select
        ...
        scai_execution.cod_execution
	  from
		crm_integration_stg.stg_pl_db_atlas_olxpl_regions,
    (
        select
          max(fac.cod_execution) cod_execution
        from
...
using crm_integration_anlt.tmp_pl_load_region
where 
	tmp_pl_load_region.dml_type = 'I' 
	and t_lkp_region.opr_region = tmp_pl_load_region.opr_region
	and t_lkp_region.valid_from = (select dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_region');

	--$$$

update crm_integration_anlt.t_lkp_region
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_region') 
from crm_integration_anlt.tmp_pl_load_region source
...
insert into crm_integration_anlt.t_lkp_region
    select
      ...
      dsc_region_ru,
      dsc_region_hi,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_region') valid_from, 
      20991231 valid_to,
      cod_source_system,
      code,
      domain,
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pl_load_region
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_region),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pl_load_subregion;

create table crm_integration_anlt.tmp_pl_load_subregion 
distkey(cod_source_system)
  ...
  from
	...
	(
      SELECT
        ...
        scai_execution.cod_execution
      FROM
        crm_integration_stg.stg_pl_db_atlas_verticals_subregions a,
        crm_integration_anlt.t_lkp_source_system b,
       (
          select
            max(fac.cod_execution) cod_execution
...
analyze crm_integration_anlt.tmp_pl_load_subregion;
	
	--$$$
	
delete from crm_integration_anlt.t_lkp_subregion
using crm_integration_anlt.tmp_pl_load_subregion
where 
	tmp_pl_load_subregion.dml_type = 'I' 
	and t_lkp_subregion.opr_subregion = tmp_pl_load_subregion.opr_subregion
	and t_lkp_subregion.valid_from = (select dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_subregion');

	--$$$
	
update crm_integration_anlt.t_lkp_subregion
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_subregion') 
from crm_integration_anlt.tmp_pl_load_subregion source
...
insert into crm_integration_anlt.t_lkp_subregion
    select
      ...
      dsc_subregion_uk,
      (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_subregion') valid_from, 
      20991231 valid_to,
      cod_region,
      cod_source_system,
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pl_load_subregion
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_subregion),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pl_load_city;

create table crm_integration_anlt.tmp_pl_load_city 
distkey(cod_source_system)
...
insert into crm_integration_anlt.t_lkp_city
    select
		...
		dsc_city_en,
		dsc_city_pl,
		(select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_city') valid_from, 
		20991231 valid_to,
		...
		cod_execution
    from
      crm_integration_anlt.tmp_pl_load_city
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_city),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pl_load_ad_aux_horz;

create table crm_integration_anlt.tmp_pl_load_ad_aux_horz
as
	(
select
			opr_ad,
...
SELECT
				...
				scai_execution.cod_execution
			  FROM
				crm_integration_stg.stg_pl_db_atlas_olxpl_ads,
				(
				  select
					max(fac.cod_execution) cod_execution
				  from
...
analyze crm_integration_anlt.tmp_pl_load_ad_aux_horz;

	--$$$

drop table if exists crm_integration_anlt.tmp_pl_load_ad_aux;

create table crm_integration_anlt.tmp_pl_load_ad_aux
distkey(opr_ad)
...
SELECT
		...
		scai_execution.cod_execution
      FROM
		crm_integration_stg.stg_pl_db_atlas_verticals_ads a,
		crm_integration_anlt.t_lkp_source_system b,
    (
      select
        max(fac.cod_execution) cod_execution
	  ...
	  select
			...
			cod_execution
	  from
		crm_integration_anlt.tmp_pl_load_ad_aux_horz
);

analyze crm_integration_anlt.tmp_pl_load_ad_aux;

	--$$$

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step1;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step1
distkey(opr_ad)
...
as
  SELECT
      ...
      lkp_source_system.cod_source_system
  FROM
      crm_integration_anlt.tmp_pl_load_ad_aux source,
      crm_integration_anlt.t_lkp_source_system lkp_source_system
  where
      source.opr_source_system = lkp_source_system.opr_source_system;

analyze crm_integration_anlt.tmp_pl_load_ad_md5_step1;


drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_0;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_0
...
select
  ...
  (
   ...
   FROM
  crm_integration_anlt.tmp_pl_load_ad_md5_step1 source;

analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_0;

	--$$$

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_1;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_1
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_0 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_1;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_2;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_2
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_1 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_2;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_3;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_3
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_2 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_3;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_4;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_4
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_3 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_4;


drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_5;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_5
--distkey(opr_source)
sortkey(opr_source)
 as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_4 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_5;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_6;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_6
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_5 source,
  crm_integration_anlt.t_lkp_source lkp_source
 where
  source.opr_source = lkp_source.opr_source
  and lkp_source.valid_to = 20991231;

analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_6;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_7;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_7
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_6 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_7;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_8;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_8
...
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_7 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_8;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_9;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_9
--distkey(opr_ad)
sortkey(opr_ad)
as
 select
  ...
  source.cod_execution
 from
  crm_integration_anlt.tmp_pl_load_ad_md5_step2_8 source,
...
analyze crm_integration_anlt.tmp_pl_load_ad_md5_step2_9;

drop table if exists crm_integration_anlt.tmp_pl_load_ad_md5_step2_10;

create table crm_integration_anlt.tmp_pl_load_ad_md5_step2_10
--distkey(cod_ad)
sortkey(cod_ad)
as
 select
...
using crm_integration_anlt.tmp_pl_load_ad_md5_step2_10
where 
	tmp_pl_load_ad_md5_step2_10.dml_type = 'I' 
	and t_lkp_ad.cod_ad = tmp_pl_load_ad_md5_step2_10.cod_ad
	and t_lkp_ad.valid_from = (select dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_ad');
	
	--$$$
	
update crm_integration_anlt.t_lkp_ad
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_ad')
from crm_integration_anlt.tmp_pl_load_ad_md5_step2_10 source
...
insert into crm_integration_anlt.t_lkp_ad
    select
		...
		dsc_ad_title,
		dsc_ad,
		(select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 2 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_ad') valid_from, 
		20991231 valid_to,
		cod_source_system,
		cod_category,
		null cod_city,
		...
		cod_execution
    from
      crm_integration_anlt.tmp_pl_load_ad_md5_step2_10
    where
      dml_type in ('U','I');
...
(
  select
    ...
    scai_execution.cod_execution
  from
    crm_integration_stg.stg_pl_db_atlas_verticals_answers a,
    crm_integration_anlt.t_lkp_source_system b,
    (
		select
		  max(fac.cod_execution) cod_execution
  ...
  select
    ...
    scai_execution.cod_execution
  from
    crm_integration_stg.stg_pl_db_atlas_olxpl_answers,
    (select cod_source_system from crm_integration_anlt.t_lkp_source_system
      where opr_source_system = 'olxpl'),
    (
		select
		  max(fac.cod_execution) cod_execution
		from
...
as
  ...
  from
    crm_integration_anlt.tmp_pl_load_answer_step1_outgoing source_table,
...
as
  select
	...
	source_table.cod_execution
  from
    crm_integration_anlt.tmp_pl_load_answer_step2_outgoing source_table,
...
insert into crm_integration_anlt.t_fac_answer_outgoing
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pl_load_answer_step3_outgoing;
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_answer_step2_outgoing),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
as
  select
    ...
    row_number() over (order by source_table.opr_answer desc) new_cod
  from
    crm_integration_anlt.tmp_pl_load_answer_step1_incoming source_table,
...
as
  select
	...
	source_table.cod_execution
  from
    crm_integration_anlt.tmp_pl_load_answer_step2_incoming source_table,
    crm_integration_anlt.t_lkp_ad lkp_ad
  where
    coalesce(source_table.opr_ad,-1) = lkp_ad.opr_ad
    and source_table.cod_source_system = lkp_ad.cod_source_system -- new
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_answer_step2_incoming),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pl_load_paidad_user_payment;

create table crm_integration_anlt.tmp_pl_load_paidad_user_payment 
  ...
  from
    (
      ...
      SELECT
        ...
        scai_execution.cod_execution
            FROM
              crm_integration_stg.stg_pl_db_atlas_verticals_paidads_user_payments a,
              crm_integration_anlt.t_lkp_source_system b,
             (
              select
                max(fac.cod_execution) cod_execution
      ...
      SELECT
        ...
        scai_execution.cod_execution
            FROM
              crm_integration_stg.stg_pl_db_atlas_olxpl_paidads_user_payments,
              (
                select
                  max(fac.cod_execution) cod_execution
                from
...
insert into crm_integration_anlt.t_hst_paidad_user_payment
    ...
    from
      crm_integration_anlt.t_fac_paidad_user_payment target,
      crm_integration_anlt.tmp_pl_load_paidad_user_payment source
    where
...
using crm_integration_anlt.tmp_pl_load_paidad_user_payment
where crm_integration_anlt.t_fac_paidad_user_payment.cod_paidad_user_payment=crm_integration_anlt.tmp_pl_load_paidad_user_payment.cod_paidad_user_payment
and crm_integration_anlt.tmp_pl_load_paidad_user_payment.dml_type = 'U';
...
insert into crm_integration_anlt.t_fac_paidad_user_payment
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pl_load_paidad_user_payment
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_paidad_user_payment),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create table crm_integration_anlt.tmp_pl_load_payment_session 
    ...
    (
	  ...
	  (
            SELECT
				...
				scai_execution.cod_execution
            FROM
            crm_integration_stg.stg_pl_db_atlas_verticals_payment_session a,
            crm_integration_anlt.t_lkp_source_system b,
            (
              select
                max(fac.cod_execution) cod_execution
			...
			SELECT
				...
				scai_execution.cod_execution
			FROM
				crm_integration_stg.stg_pl_db_atlas_olxpl_payment_session,
        (
          select
            max(fac.cod_execution) cod_execution
          from
...
analyze crm_integration_anlt.tmp_pl_load_payment_session;
...
insert into crm_integration_anlt.t_hst_payment_session
    ...
    from
      crm_integration_anlt.t_fac_payment_session target,
      crm_integration_anlt.tmp_pl_load_payment_session source
    where
...
using crm_integration_anlt.tmp_pl_load_payment_session
where crm_integration_anlt.t_fac_payment_session.cod_payment_session=crm_integration_anlt.tmp_pl_load_payment_session.cod_payment_session
and crm_integration_anlt.tmp_pl_load_payment_session.dml_type = 'U';
...
insert into crm_integration_anlt.t_fac_payment_session
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pl_load_payment_session
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_payment_session),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pl_load_payment_basket;

create table crm_integration_anlt.tmp_pl_load_payment_basket 
...
as
  ...
  from
    ...
    from
      (
            SELECT
              ...
              scai_execution.cod_execution
            FROM
              crm_integration_stg.stg_pl_db_atlas_verticals_payment_basket a,
              crm_integration_anlt.t_lkp_source_system b,
              (
                select
                  max(fac.cod_execution) cod_execution
    ...
    SELECT
        ...
        scai_execution.cod_execution
    FROM
        crm_integration_stg.stg_pl_db_atlas_olxpl_payment_basket,
    		 (
          select
            max(fac.cod_execution) cod_execution
          from
...
analyze crm_integration_anlt.tmp_pl_load_payment_basket;
...
insert into crm_integration_anlt.t_hst_payment_basket
    ...
    from
      crm_integration_anlt.t_fac_payment_basket target,
      crm_integration_anlt.tmp_pl_load_payment_basket source
    where
...
using crm_integration_anlt.tmp_pl_load_payment_basket
where crm_integration_anlt.t_fac_payment_basket.cod_payment_basket=crm_integration_anlt.tmp_pl_load_payment_basket.cod_payment_basket
and crm_integration_anlt.tmp_pl_load_payment_basket.dml_type = 'U';
...
insert into crm_integration_anlt.t_fac_payment_basket
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pl_load_payment_basket
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pl_load_payment_basket),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
