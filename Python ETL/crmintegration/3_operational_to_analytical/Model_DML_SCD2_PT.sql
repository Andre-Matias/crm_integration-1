...
as
  ...
  where
	...
	and source_table.cod_source_system = target.cod_source_system (+); -- Portugal
...
drop table if exists crm_integration_anlt.tmp_pt_load_region;

create table crm_integration_anlt.tmp_pt_load_region 
distkey(cod_source_system)
  ...
  from
	...
	(
      SELECT
        ...
        scai_execution.cod_execution
      FROM
        crm_integration_stg.stg_pt_db_atlas_verticals_regions a,
        crm_integration_anlt.t_lkp_source_system b,
        (
          select
            max(fac.cod_execution) cod_execution
	  ...
	  select
        ...
        scai_execution.cod_execution
	  from
		crm_integration_stg.stg_pt_db_atlas_olxpt_regions,
    (
        select
          max(fac.cod_execution) cod_execution
        from
...
analyze crm_integration_anlt.tmp_pt_load_region;
	
	--$$$

delete from crm_integration_anlt.t_lkp_region
using crm_integration_anlt.tmp_pt_load_region
where 
	tmp_pt_load_region.dml_type = 'I' 
	and t_lkp_region.opr_region = tmp_pt_load_region.opr_region
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 1 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_region') 
from crm_integration_anlt.tmp_pt_load_region source
...
insert into crm_integration_anlt.t_lkp_region
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pt_load_region
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pt_load_region),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pt_load_subregion;

create table crm_integration_anlt.tmp_pt_load_subregion 
distkey(cod_source_system)
  ...
  from
	...
	(
      SELECT
        ...
        scai_execution.cod_execution
      FROM
        crm_integration_stg.stg_pt_db_atlas_verticals_subregions a,
        crm_integration_anlt.t_lkp_source_system b,
       (
          select
            max(fac.cod_execution) cod_execution
...
analyze crm_integration_anlt.tmp_pt_load_subregion;
	
	--$$$
	
delete from crm_integration_anlt.t_lkp_subregion
using crm_integration_anlt.tmp_pt_load_subregion
where 
	tmp_pt_load_subregion.dml_type = 'I' 
	and t_lkp_subregion.opr_subregion = tmp_pt_load_subregion.opr_subregion
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 1 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_subregion') 
from crm_integration_anlt.tmp_pt_load_subregion source
...
insert into crm_integration_anlt.t_lkp_subregion
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pt_load_subregion
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pt_load_subregion),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pt_load_city;

create table crm_integration_anlt.tmp_pt_load_city 
distkey(cod_source_system)
...
select
  ...
  SELECT
		...
		scai_execution.cod_execution
      FROM
        crm_integration_stg.stg_pt_db_atlas_verticals_cities a,
        crm_integration_anlt.t_lkp_source_system b,
        (
          select
            max(fac.cod_execution) cod_execution
    ...
    where
	  ...
	  select
	    a.id opr_city,
			...
			scai_execution.cod_execution
      FROM
        crm_integration_stg.stg_pt_db_atlas_olxpt_cities a,
        (
          select
            max(fac.cod_execution) cod_execution
          from
...
analyze crm_integration_anlt.tmp_pt_load_city;
	
	--$$$
	
delete from crm_integration_anlt.t_lkp_city
using crm_integration_anlt.tmp_pt_load_city
where 
	tmp_pt_load_city.dml_type = 'I' 
	and t_lkp_city.opr_city = tmp_pt_load_city.opr_city
...
set valid_to = (select rel_integr_proc.dat_processing from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc where rel_integr_proc.cod_process = proc.cod_process and rel_integr_proc.cod_country = 1 and rel_integr_proc.cod_integration = 30000 and rel_integr_proc.ind_active = 1 and proc.dsc_process_short = 't_lkp_city') 
from crm_integration_anlt.tmp_pt_load_city source
...
insert into crm_integration_anlt.t_lkp_city
    select
		...
		cod_execution
    from
      crm_integration_anlt.tmp_pt_load_city
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pt_load_city),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
drop table if exists crm_integration_anlt.tmp_pt_load_ad_aux_horz;

create table crm_integration_anlt.tmp_pt_load_ad_aux_horz 
as
	(
select
			opr_ad,
...
SELECT
				...
				scai_execution.cod_execution
			  FROM
				crm_integration_stg.stg_pt_db_atlas_olxpt_ads,
				(
				  select
					max(fac.cod_execution) cod_execution
				  from
...
analyze crm_integration_anlt.tmp_pt_load_ad_aux_horz;

	--$$$

drop table if exists crm_integration_anlt.tmp_pt_load_ad_aux;

create table crm_integration_anlt.tmp_pt_load_ad_aux
distkey(opr_ad)
...
SELECT
		...
		scai_execution.cod_execution
      FROM
		crm_integration_stg.stg_pt_db_atlas_verticals_ads a,
		crm_integration_anlt.t_lkp_source_system b,
    (
      select
        max(fac.cod_execution) cod_execution
	  ...
	  select
			...
			cod_execution
	  from
		crm_integration_anlt.tmp_pt_load_ad_aux_horz
);

analyze crm_integration_anlt.tmp_pt_load_ad_aux;

	--$$$

drop table if exists crm_integration_anlt.tmp_pt_load_ad_md5_step1;
	
create table crm_integration_anlt.tmp_pt_load_ad_md5_step1
distkey(opr_ad)
...
as
  SELECT
      ...
      lkp_source_system.cod_source_system
  FROM
      crm_integration_anlt.tmp_pt_load_ad_aux source,
      crm_integration_anlt.t_lkp_source_system lkp_source_system
  where
      source.opr_source_system = lkp_source_system.opr_source_system;	
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pt_load_ad_aux),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
create table crm_integration_anlt.tmp_pt_load_answer_step3_outgoing
distkey(opr_answer)
...
as
  select
	...
	source_table.cod_execution
  from
    crm_integration_anlt.tmp_pt_load_answer_step2_outgoing source_table,
...
analyze crm_integration_anlt.tmp_pt_load_answer_step3_outgoing;
	
	--$$$
	
insert into crm_integration_anlt.t_hst_answer_outgoing
select * from crm_integration_anlt.t_fac_answer_outgoing
where crm_integration_anlt.t_fac_answer_outgoing.opr_answer in (select distinct opr_answer from crm_integration_anlt.tmp_pt_load_answer_step3_outgoing)
and crm_integration_anlt.t_fac_answer_outgoing.cod_source_system in (select distinct cod_source_system from crm_integration_anlt.tmp_pt_load_answer_step3_outgoing);
...
insert into crm_integration_anlt.t_fac_answer_outgoing
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pt_load_answer_step3_outgoing;
...
drop table if exists crm_integration_anlt.tmp_pt_load_answer_step3_outgoing;
...
create table crm_integration_anlt.tmp_pt_load_answer_step3_incoming
distkey(opr_answer)
sortkey(opr_answer, cod_source_system)
as
  select
	...
	source_table.cod_execution
  from
    crm_integration_anlt.tmp_pt_load_answer_step2_incoming source_table,
    crm_integration_anlt.t_lkp_ad lkp_ad
  where
    coalesce(source_table.opr_ad,-1) = lkp_ad.opr_ad
    and source_table.cod_source_system = lkp_ad.cod_source_system -- new
...
analyze crm_integration_anlt.tmp_pt_load_answer_step3_incoming;
...
insert into crm_integration_anlt.t_fac_answer_incoming
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pt_load_answer_step3_incoming;
...
drop table if exists crm_integration_anlt.tmp_pt_load_answer_step3_incoming;
  ...
  from
    (
      ...
      SELECT
        ...
        scai_execution.cod_execution
            FROM
              crm_integration_stg.stg_pt_db_atlas_verticals_paidads_user_payments a,
              crm_integration_anlt.t_lkp_source_system b,
             (
              select
                max(fac.cod_execution) cod_execution
      ...
      SELECT
        ...
        scai_execution.cod_execution
            FROM
              crm_integration_stg.stg_pt_db_atlas_olxpt_paidads_user_payments,
              (
                select
                  max(fac.cod_execution) cod_execution
                from
...
drop table if exists crm_integration_anlt.tmp_pt_load_payment_session;

create table crm_integration_anlt.tmp_pt_load_payment_session 
    ...
    (
	  ...
	  (
            SELECT
				...
				scai_execution.cod_execution
            FROM
            crm_integration_stg.stg_pt_db_atlas_verticals_payment_session a,
            crm_integration_anlt.t_lkp_source_system b,
            (
              select
                max(fac.cod_execution) cod_execution
			...
			SELECT
				...
				scai_execution.cod_execution
			FROM
				crm_integration_stg.stg_pt_db_atlas_olxpt_payment_session,
        (
          select
            max(fac.cod_execution) cod_execution
          from
...
analyze crm_integration_anlt.tmp_pt_load_payment_session;
...
insert into crm_integration_anlt.t_hst_payment_session
    ...
    from
      crm_integration_anlt.t_fac_payment_session target,
      crm_integration_anlt.tmp_pt_load_payment_session source
    where
...
using crm_integration_anlt.tmp_pt_load_payment_session
where crm_integration_anlt.t_fac_payment_session.cod_payment_session=crm_integration_anlt.tmp_pt_load_payment_session.cod_payment_session
and crm_integration_anlt.tmp_pt_load_payment_session.dml_type = 'U';
...
insert into crm_integration_anlt.t_fac_payment_session
    select
	  ...
	  cod_execution
    from
      crm_integration_anlt.tmp_pt_load_payment_session
    where
      dml_type in ('U','I');
...
update crm_integration_anlt.t_rel_scai_integration_process
set cod_status = 1, -- Ok
last_processing_datetime = coalesce((select max(operation_timestamp) from crm_integration_anlt.tmp_pt_load_payment_session),last_processing_datetime)
/*from
  (
    select proc.cod_process, rel_country_integr.dat_processing, rel_country_integr.cod_country, rel_country_integr.execution_nbr, rel_country_integr.cod_status, rel_country_integr.cod_integration
    from crm_integration_anlt.t_lkp_scai_process proc, crm_integration_anlt.t_rel_scai_integration_process rel_integr_proc, crm_integration_anlt.t_rel_scai_country_integration rel_country_integr
...
as
  ...
  from
    ...
    from
      (
            SELECT
              ...
              scai_execution.cod_execution
            FROM
              crm_integration_stg.stg_pt_db_atlas_verticals_payment_basket a,
              crm_integration_anlt.t_lkp_source_system b,
              (
                select
                  max(fac.cod_execution) cod_execution
    ...
    SELECT
        ...
        scai_execution.cod_execution
    FROM
        crm_integration_stg.stg_pt_db_atlas_olxpt_payment_basket,
    		 (
          select
            max(fac.cod_execution) cod_execution
          from
