...
create temp table tmp_pt_olx_calc_number_calls_1 as
select
  base_contact.cod_contact, 
  to_char(call.created_at,'YYYYMM') as custom_field_value,
  scai.dat_processing dat_snap,
  coalesce(base_contact.cod_source_system,16) cod_source_system
from
  crm_integration_anlt.t_fac_call call,
  crm_integration_anlt.t_lkp_contact base_contact,
  crm_integration_anlt.t_rel_scai_country_integration scai
where 1=1
  and call.cod_source_system = 16
...
create temp table tmp_pt_olx_calc_number_calls_2 as
select
	source.cod_contact,
	source.cod_custom_field,
	source.dat_snap,
...
from
	(    select
      ...
      kpi_custom_field.cod_custom_field,
      scai.dat_processing dat_snap,
      coalesce(a.cod_source_system,16) cod_source_system,
      a.custom_field_value custom_field_value
    from
    (	select
		 cod_contact, 
		 ...
		 dat_snap,
		 cod_source_system
		from  tmp_pt_olx_calc_number_calls_1
		where 1=1 
...
insert into crm_integration_anlt.t_hst_base_integration_snap
    ...
    from
      crm_integration_anlt.t_fac_base_integration_snap target
    where (cod_contact, cod_custom_field) in (select cod_contact, cod_custom_field from tmp_pt_olx_calc_number_calls_2);
...
insert into crm_integration_anlt.t_fac_base_integration_snap
  select
    *
  from
    tmp_pt_olx_calc_number_calls_2;
...
create temp table tmp_pt_olx_calc_number_calls_3 as
select
	source.cod_contact,
	source.cod_custom_field,
	source.dat_snap,
...
insert into crm_integration_anlt.t_hst_base_integration_snap
    ...
    from
      crm_integration_anlt.t_fac_base_integration_snap target
    where (cod_contact, cod_custom_field) in (select cod_contact, cod_custom_field from tmp_pt_olx_calc_number_calls_3);
...
insert into crm_integration_anlt.t_fac_base_integration_snap
  select
    *
  from
    tmp_pt_olx_calc_number_calls_3;
...
create temp table tmp_pt_olx_calc_number_calls_4 as
select
	source.cod_contact,
	source.cod_custom_field,
	source.dat_snap,
...
insert into crm_integration_anlt.t_hst_base_integration_snap
    ...
    from
      crm_integration_anlt.t_fac_base_integration_snap target
    where (cod_contact, cod_custom_field) in (select cod_contact, cod_custom_field from tmp_pt_olx_calc_number_calls_4);
...
insert into crm_integration_anlt.t_fac_base_integration_snap
  select
    *
  from
    tmp_pt_olx_calc_number_calls_4;	
