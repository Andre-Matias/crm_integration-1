...
def deletePreviousS3Files(conf_file, keyId, sKeyId):
	...
	for x in b.list(prefix = 'renato-teixeira/contacts/imopt/'):
		x.delete()
...
def s3_fulldump_contacts(client,keyId,sKeyId,bucketName,data_path,category,country):
	...
	aux = 1
	name = "./Reports/aut_imopt_base_to_bd_contacts_"
	while 1:
		...
		fileName="aut_imopt_base_to_bd_contacts_" + str(aux).zfill(10) + ".txt.gz"
