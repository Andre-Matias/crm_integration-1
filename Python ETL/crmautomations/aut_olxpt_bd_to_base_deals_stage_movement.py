...
#print('Start Truncate aut_olxpt_base_to_bd_stages_stage_movement: ' + time.strftime("%H:%M:%S"))
#cur.execute("truncate table sandbox_andre_matias.aut_olxpt_base_to_bd_stages_stage_movement; ")
#print('End Truncate aut_olxpt_base_to_bd_stages_stage_movement: ' + time.strftime("%H:%M:%S"))

#print('Start Truncate aut_olxpt_base_to_bd_deals_stage_movement: ' + time.strftime("%H:%M:%S"))
#cur.execute("truncate table sandbox_andre_matias.aut_olxpt_base_to_bd_deals_stage_movement; ")
#print('End Truncate aut_olxpt_base_to_bd_deals_stage_movement: ' + time.strftime("%H:%M:%S"))

#aut_olxpt_base_to_bd_stages_stage_movement.main(conf_file) 
#aut_olxpt_base_to_bd_deals_stage_movement.main(conf_file)
...
cur.execute(
			"select "\
              ...
              "b.name "\
            "from "\
              "sandbox_andre_matias.aut_olxpt_base_to_bd_deals_stage_movement a, "\
              "sandbox_andre_matias.aut_olxpt_base_to_bd_stages_stage_movement b "\
            "where "\
