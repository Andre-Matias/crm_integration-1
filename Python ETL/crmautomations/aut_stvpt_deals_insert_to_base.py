...
#base_api_token = '81aef80f2a67ff2d70f0d905c15aa9fe5db3339f51a377370f585aa128ecc77f'
...
cur.execute(
            ...
            "where "\
            	...
            	"and lkp_atlas_user.cod_source_system = 4 "\
            	...
            	#"and lkp_pi.paidad_index_code not in('topupaccount','expiredcredits', 'removecredits') "\
				"and lkp_pi.flg_aut_deal_exclude != 1 "\
				"and lkp_pi.cod_source_system = 4 "\
            	"and val_price < 0 "\
				#"and fac.opr_paidad_user_payment = 6222281 "\
				"and dat_payment > (select last_processing_datetime from sandbox_andre_matias.aut_deals_insert_to_base_dates where source_system = 'ptcars') "\
...
cur.execute(
			"delete from sandbox_andre_matias.aut_deals_insert_to_base_dates where source_system = 'ptcars'; ")
