...
end end end end end end end end end end end end source
,case when split_part(traffic_source,'--',1) = 'utm' then split_part(traffic_source,'--',2) end utm_source
,case when split_part(traffic_source,'--',1) = 'utm' then split_part(traffic_source,'--',3) end utm_medium
,case when split_part(traffic_source,'--',1) = 'utm' then split_part(traffic_source,'--',4) end utm_campaign
...
order by server_date_day,country,platform,source